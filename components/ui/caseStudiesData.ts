...
export interface CaseStudySection {
  ...
  images?: CaseStudyImage[] // hasta 3 imágenes; si hay más de 1 se muestran como carrusel
...
export interface CaseStudyData {
  ...
  heroImages: CaseStudyImage[] // hasta 3 imágenes; si hay más de 1 se muestran como carrusel
  role: string
  team: string
  timeline: string
...
export const caseStudies: CaseStudyData[] = [
  {
    ...
    heroImages: [{ src: 'URL_IMAGEN_HERO', alt: 'Experta App redesign' }], // 👈 REEMPLAZAR (podés agregar hasta 3 objetos en este array)
    role: 'PRODUCT DESIGN',
    ...
    sections: [
      ...
      },
      {
        ...
        images: [{ src: 'URL_IMAGEN_SECUNDARIA', alt: 'Design process' }], // 👈 REEMPLAZAR (agregá más objetos al array para carrusel, hasta 3)
      },
      {
  ...
  },
  {
    ...
    heroImages: [{ src: 'URL_IMAGEN_HERO', alt: 'Systems design' }], // 👈 REEMPLAZAR (podés agregar hasta 3 objetos en este array)
    role: 'PRODUCT DESIGN',
    team: 'PRODUCT + ENGINEERING',
    timeline: '6 WEEKS',
    sections: [
      ...
      },
      {
        ...
        images: [{ src: 'URL_IMAGEN_SECUNDARIA', alt: 'Design system' }], // 👈 REEMPLAZAR (agregá más objetos al array para carrusel, hasta 3)
      },
      {
        eyebrow: '03 / THE IMPACT',
  ...
  },
  {
    ...
    heroImages: [{ src: 'URL_IMAGEN_HERO', alt: 'UX Research' }], // 👈 REEMPLAZAR (podés agregar hasta 3 objetos en este array)
    role: 'UX RESEARCH',
    ...
    sections: [
      ...
      },
      {
        ...
        images: [{ src: 'URL_IMAGEN_SECUNDARIA', alt: 'Research process' }], // 👈 REEMPLAZAR (agregá más objetos al array para carrusel, hasta 3)
      },
      {
        eyebrow: '03 / THE IMPACT',
        heading: 'Data that',
