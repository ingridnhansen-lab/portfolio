...
// ============================================================
// 📌 DATOS DE LOS PROYECTOS (tarjetas de la sección WORK)
// ============================================================
...
export const projectsData = {
  project1: {
    ...
    action: 'case', // 'case' = abre el caso de estudio
  },
  ...
  project2: {
    ...
    action: 'contact', // 'contact' = va a la sección contacto
  },
  ...
  project3: {
    ...
    action: 'about', // 'about' = va a la sección about
  },
}
