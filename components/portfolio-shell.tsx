...
export function PortfolioShell() {
  ...
  return <main>
    //Acá esta lo relacionado al hero section - textos//
    ...
    <section id="home" className="hero section-wrap"><div className="hero-copy"><p className="eyebrow"> DIGITAL PRODUCT DESIGN · UX/UI · AI · SYSTEMS <span>— BUENOS AIRES, ARGENTINA / REMOTE</span></p><h1>I TURN COMPLEX PROBLEMS<br /><em>INTO DIGITAL PRODUCTS.</em></h1><p className="hero-intro">I combine research, product thinking, UX/UI and visual craft to turn complex challenges into clear digital experiences. I approach design as a constantly evolving laboratory, exploring AI, emerging technologies and connections across disciplines.</p><p className="highlight">CONNECTING PEOPLE, PRODUCT & TECHNOLOGY.</p><p className="available"> Open to Product design roles ● Freelance projects </p><div className="hero-keywords"></div> B2B SAAS · WEB PRODUCTS · AI · STARTUPS </div></section>
    <Ticker />
    <section id="about" className="about section-wrap"><p className="section-label">01 / ABOUT</p><div className="about-grid"><div><h2>Hello, I&apos;m<br /><em>Ingrid.</em></h2><p className="mono-copy">I&apos;m a product and UX designer who likes to look closer: listening, asking uncomfortable questions, and turning complexity into something that feels simple.</p><a className="back-link about-link" href="https://www.linkedin.com/in/ingrid-hansen-382298120" target="_blank" rel="noreferrer">More about me ↗</a></div><div className="about-card"><img src={portrait} alt="Ingrid Hansen holding coffee" /></div></div></section>
