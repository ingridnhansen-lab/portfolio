...
export function PortfolioShell() {
  ...
  return <main>
    ...
    <section id="home" className="hero section-wrap"><div className="hero-copy"><p className="eyebrow"> DIGITAL PRODUCT DESIGN · UX/UI · AI · SYSTEMS <span>— BUENOS AIRES, ARGENTINA / REMOTE</span></p><h1> FROM COMPLEXITY TO<br /><em>CLARITY</em></h1><p className="hero-intro">I approach design as a constantly evolving laboratory, exploring AI, emerging technologies and connections across disciplines to craft meaningful digital experiences.</p><p className="highlight">B2B SAAS · WEB PRODUCTS · AI · STARTUPS</p><p className="available"> ● Open to Product design roles & Freelance projects </p><div className="hero-keywords"></div></div></section>
    <Ticker />
