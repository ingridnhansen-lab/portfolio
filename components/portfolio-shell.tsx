...
export function PortfolioShell() {
  ...
  return <main>
    ...
    <section id="home" className="hero section-wrap"><div className="hero-copy"><p className="eyebrow">PRODUCT & UX DESIGNER <span>— ARGENTINA / REMOTE</span></p><h1>Product & UX<br /><em>Designer.</em></h1><p className="hero-intro">I design digital experiences centered on people, solving real problems and creating meaningful impact.</p><p className="highlight">DESIGN WITH PURPOSE. CONTENT WITH IMPACT.</p><p className="available">● Available for events & collaborations</p><div className="hero-keywords">UX research · product thinking · accessible systems · content that connects</div></div></section>
    <Ticker />
